---
title: "Differences between Kos and Hall"
author: "Matt T"
date: "9/25/2020"
output:
...
---
## Calculations for CO2 concentration in water at equilibrium
Kos seems to skip parts of calculating CO2 in water based on the code. Their eqn. 1 and code do not match. The Hall code matches the Kos eqn. 1.
```{r error=TRUE}
#Kos
...
#Hall
Hall.K1<- function(temp_equil) { 10^( (-3404.71/(273.15+temp_equil)) + 14.844 -0.033*(temp_equil+273.15) )}
Hall.K2<- function(temp_equil) { 10^( (-2902.39/(273.15+temp_equil)) + 6.498 -0.0238*(temp_equil+273.15) )}
