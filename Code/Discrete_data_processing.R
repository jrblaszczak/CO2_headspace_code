...
## Export
#################
setwd("C:/Users/jblaszczak/Dropbox/FLBS shared with Bob/Projects/C isotopes/Diel Sampling/2019 October Models")
write.csv(iso, "2019_10_09_Discrete_data_allsites.csv")
