...
meta_file_name <- "2020_09_23_CO2.txt"
## 3) Specify start time of Picarro run (using Picarro time)
picarro_start_time <- "2020-09-23 20:50:00"
## 4) Specify notes file name
notes_file_name <- "2020_09_23_CO2 notes.csv"
...
## Remove standards
sum_file_merge <-sum_file_merge[!(sum_file_merge$Syringe=="Std_Tank1"|sum_file_merge$Syringe=="Std_Tank2"),]


names(sum_file_merge)
sum_file_final <- sum_file_merge[,c(1:11,18:21)]
colnames(sum_file_final)[12] <- "CO2_post"
...
## Export
###########
write.csv(sum_file_final, "2020_09_23_CO2_QAQC.csv",row.names = FALSE)
