...
$K_1 = 10^{ (-3404.71/(273.15+T)) + 14.844 -(0.033\times (T+273.15))}$

$K_2 = 10^{ (-2902.39/(273.15+T)) + 6.498 - (0.0238\times (T+273.15))}$

Where $T$ is streamwater temperature in degrees Celsius.
