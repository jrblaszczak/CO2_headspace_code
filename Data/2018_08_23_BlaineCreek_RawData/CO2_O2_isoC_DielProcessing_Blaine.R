...
## Then select only the same time points as DO measurements
...
pH_10min$DateTime <- lubridate::round_date(pH_10min$DateTime, "10 minutes") 
...
#######################################################
iso <- read.csv("2018_08_23_BlaineDiel_Picarro.csv", header=T)
...
iso_melt <- melt(notes_iso[,c("CO2","delCO2","CH4","delCH4","CO2_conc","DateTime","Site")], id.vars=c("DateTime","Site"))
...
iso_mean_melt <- melt(iso_mean[,c("CO2","delCO2","CH4","delCH4","CO2_conc","DateTime","Site")], id.vars=c("DateTime","Site"))
iso_sd_melt <- melt(iso_sd[,c("CO2","delCO2","CH4","delCH4","CO2_conc","DateTime","Site")], id.vars=c("DateTime","Site"))
